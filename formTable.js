...
function searchMatch() {
    ...
    for (let key in dataArray) {
        ...
        let k=0;
        // let setBackground = document.getElementById(idValue);
        // if(dataArray[key].name == nameSearch.value && nameSearch.value !='' || dataArray[key].age == ageSearch.value && ageSearch.value!='') {
        //     document.getElementById("noResult").innerHTML = ''    
        //     console.log('In match condition....')
        //     setBackground.style.backgroundColor = '#FF0000'
        //     c++;
        // }
        // else{
        //     console.log('onelse....')
